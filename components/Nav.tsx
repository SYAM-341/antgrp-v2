...
const NAV: NavItem[] = [
    ...
    columns: [
      {
        title: "Technology",
        links: [
          { href: "/solutions#cloud", label: "Cloud Modernization", desc: "Migration, FinOps, scale." },
          { href: "/solutions#data", label: "Data & Analytics", desc: "Pipelines that drive decisions." },
          { href: "/solutions#agentic", label: "Agentic AI", desc: "Production-grade AI agents." },
          { href: "/solutions#devops", label: "DevOps & Platform", desc: "Reliable delivery at speed." },
        ],
      },
      {
        title: "Industry",
        links: [
          { href: "/industries#it", label: "IT Consulting & Staffing", desc: "Right talent, right time." },
          { href: "/industries#realestate", label: "Real Estate", desc: "Acquisition & advisory." },
          { href: "/industries#agriculture", label: "Agriculture", desc: "Sustainable operations." },
          { href: "/industries#automotive", label: "Automotive", desc: "Future-ready ventures." },
        ],
      },
    ],
  },
  {
    ...
    columns: [
      {
        links: [
          { href: "/services#staffing", label: "IT Staffing", desc: "Vetted engineers, on demand." },
          { href: "/services#delivery", label: "Project Delivery", desc: "Outcome-based engagements." },
          { href: "/services#qa", label: "QA as a Service", desc: "Defects found before users do." },
        ],
      },
      {
        links: [
          { href: "/services#app", label: "App Development", desc: "Idea to launch, end to end." },
          { href: "/services#cloud", label: "Cloud & DevOps", desc: "Infrastructure that scales." },
          { href: "/services#hosting", label: "Managed Hosting", desc: "Monitored, always on." },
        ],
      },
    ],
  },
  {
    ...
    columns: [
      {
        links: [
          { href: "/industries#it", label: "IT Consulting & Staffing", desc: "Engineering talent network." },
          { href: "/industries#realestate", label: "Real Estate", desc: "Acquisition, management, advisory." },
        ],
      },
      {
        links: [
          { href: "/industries#agriculture", label: "Agriculture", desc: "Sustainable, compliant growth." },
          { href: "/industries#automotive", label: "Automotive", desc: "Ventures and partnerships." },
        ],
      },
    ],
  },
    ...
    columns: [
      {
        links: [
          ...
          { href: "/about#process", label: "Our Process", desc: "How we deliver." },
        ],
      },
      {
        links: [
              ...
              <ul className="space-y-3">
                {col.links.map((l) => (
                  <li key={l.href + l.label}>
                    <Link href={l.href} className="group/item block rounded-md p-1 -m-1 hover:bg-soft">
                      <div className="text-sm font-semibold text-ink group-hover/item:text-brand-2 transition">
                        {l.label}
                      </div>
                      {l.desc ? (
                        <div className="mt-0.5 text-xs text-zinc-500">{l.desc}</div>
                      ) : null}
                    </Link>
                  </li>
                ))}
                ...
                <div key={item.label}>
                  ...
                  <ul className="mt-2 space-y-1.5">
                    {(item.columns ?? []).flatMap((c) => c.links).map((l) => (
                      <li key={l.href + l.label}>
                        <Link href={l.href} onClick={() => setOpen(false)} className="block py-1 text-sm font-semibold text-ink">
                          {l.label}
                        </Link>
                      </li>
                    ))}
